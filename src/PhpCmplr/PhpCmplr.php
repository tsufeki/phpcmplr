...
use PhpCmplr\Core\FileStore;
use PhpCmplr\Core\Project;
use PhpCmplr\Core\ProjectRootDirectoryGuesser;
...
use PhpCmplr\Core\Diagnostics\Diagnostics;
...
use PhpCmplr\Core\Indexer\Indexer;
use PhpCmplr\Core\Indexer\IndexerInterface;
use PhpCmplr\Core\Indexer\ReflectionIndexData;
use PhpCmplr\Core\Indexer\IndexLocator;
use PhpCmplr\Core\Indexer\IndexNamespaceReflection;
...
use PhpCmplr\Core\Completer\VariableCompleter;
